...
static const SettingsLocale kEnglish = {
    ...
    /* gameSyncHDCollectionLabel */ "Sync settings with HD collection",
    /* gameSyncHDCollectionDesc */  "Load resolution and control settings from the HD collection on startup.",
