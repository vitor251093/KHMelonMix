...
#define PLUGIN_ARRAY_SIZE_LIMIT 100
...
public:
    ...
    virtual void applyCustomKeysToInputMaskOrTouchControls(u32* InputMask, u16* touchX, u16* touchY, bool* isTouching, u32* HotkeyMask, u32* HotkeyPress) {};
