...
#define PAUSE_SCREEN_TYPE_ADDRESS_US      0x0204bd84
#define PAUSE_SCREEN_TYPE_ADDRESS_EU      0x0204bda4
#define PAUSE_SCREEN_TYPE_ADDRESS_JP      0x0204c1e4
#define PAUSE_SCREEN_TYPE_ADDRESS_JP_REV1 0x0204c60c

#define PAUSE_SCREEN_WITH_WITHDRAW_VALUE_US      0x02
#define PAUSE_SCREEN_WITH_WITHDRAW_VALUE_EU      0x02
#define PAUSE_SCREEN_WITH_WITHDRAW_VALUE_JP      0x02
#define PAUSE_SCREEN_WITH_WITHDRAW_VALUE_JP_REV1 0x00 // TODO: KH ?

#define PAUSE_SCREEN_WITH_SKIP_VALUE_US      0x04
#define PAUSE_SCREEN_WITH_SKIP_VALUE_EU      0x04
#define PAUSE_SCREEN_WITH_SKIP_VALUE_JP      0x04
#define PAUSE_SCREEN_WITH_SKIP_VALUE_JP_REV1 0x00 // TODO: KH ?

#define PAUSE_SCREEN_WITHOUT_LABEL_WITH_WITHDRAW_VALUE_US      0x80
#define PAUSE_SCREEN_WITHOUT_LABEL_WITH_WITHDRAW_VALUE_EU      0x80
#define PAUSE_SCREEN_WITHOUT_LABEL_WITH_WITHDRAW_VALUE_JP      0x80
#define PAUSE_SCREEN_WITHOUT_LABEL_WITH_WITHDRAW_VALUE_JP_REV1 0x00 // TODO: KH ?
...
PluginKingdomHeartsDays::PluginKingdomHeartsDays(u32 gameCode)
{
    ...
    Cutscenes = std::array<Plugins::CutsceneEntry, 46> {{
        {"802",    "hd802_mm", "802_opening",                       0x088b2e00, 0x08b3d400, 0x0876e800, 0, 1},
        {"803",    "hd803",    "803_meet_xion",                     0x0987ec00, 0x09b09200, 0x097c8800, 0, 1},
        {"804",    "hd804",    "804_roxas_recusant_sigil",          0x09ae9400, 0x09d73a00, 0x09a4e000, 0, 1},
        {"805",    "hd805",    "805_the_dark_margin",               0x09b80600, 0x09e0ac00, 0x09aeb200, 0, 1},
        {"806",    "hd806",    "806_sora_entering_pod",             0x09e83800, 0x0a10de00, 0x09e0ba00, 0, 1},
        {"808",    "hd808",    "808_sunset_memory",                 0x09f24c00, 0x0a1af200, 0x09eb2e00, 0, 1},
        {"809",    "hd809",    "809_xions_defeat",                  0x09f79400, 0x0a203a00, 0x09f0ac00, 0, 1},
        {"810",    "hd810",    "810_the_main_in_black_reflects",    0x09ff8000, 0x0a282600, 0x09f8d400, 0, 1},
        {"813",    "hd813_mm", "813_xions_defeat",                  0x0a13f600, 0x0a3c9c00, 0x0a0e1600, 0, 1},
        {"814",    "hd814",    "814_sora_walk",                     0x0a677c00, 0x0a902200, 0x0a64f000, 0, 1},
        {"815",    "hd815",    "815_sora_release_kairi",            0x0a6e4200, 0x0a96e800, 0x0a6bf000, 0, 1},
        {"816",    "hd816",    "816_kairi_memories",                0x0a7a9200, 0x0aa33800, 0x0a78ca00, 0, 1},
        {"817",    "hd817_mm", "817_namine_and_diz",                0x0a857600, 0x0aae1c00, 0x0a845800, 0, 1},
        {"818",    "hd818_mm", "818_why_the_sun_sets_red",          0x0ab4be00, 0x0add6400, 0x0ab57800, 0, 1},
        {"819",    "hd819",    "819_sora_wakes_up",                 0x0afeac00, 0x0afeac00, 0x0afeac00, 0, 1}, // double cutscene complement
        {"821",    "hd821_mm", "821_snarl_of_memories",             0x0b043e00, 0x0b2ce400, 0x0b084a00, 0, 1},
        {"822",    "hd822",    "822_riku_takes_care_of_xion",       0x0b514600, 0x0b79ec00, 0x0b57ea00, 0, 1},
        {"823",    "hd823",    "823_roxas_passes_by",               0x0b5b5e00, 0x0b840400, 0x0b626e00, 0, 1},
        {"824",    "hd824_mm", "824_xions_dream",                   0x0b65a200, 0x0b8e4800, 0x0b6d1800, 0, 1},
        {"825",    "hd825_mm", "825_xions_capture",                 0x0b8a7a00, 0x0bb32000, 0x0b937600, 0, 1},
        {"826",    "hd826",    "826_hollow_bastion_memories",       0x0bd74600, 0x0bffec00, 0x0be21a00, 0, 1},
        {"827",    "hd827",    "827_agrabah_keyhole_memory",        0x0be7e000, 0x0c108600, 0x0bf35400, 0, 1},
        {"828",    "hd828_mm", "828_xion_and_riku",                 0x0bedf200, 0x0c169800, 0x0bf9ae00, 0, 1},
        {"829",    "hd829_mm", "829_rikus_resolve",                 0x0c76a800, 0x0c9f4e00, 0x0c873400, 0, 1},
        {"830",    "hd830_mm", "830_day_354_mickey_and_riku_ansem", 0x0c863a00, 0x0caee000, 0x0c981000, 60, 1|0x10000},
        {"831",    "hd831",    "831_xion_and_namine",               0x0ca47c00, 0x0ccd2200, 0x0cb79400, 0, 1},
        {"832",    "hd832_mm", "832_xion_and_axel_face_off",        0x0cb01c00, 0x0cd8c200, 0x0cc3b000, 0, 1},
        {"833",    "hd833_mm", "833_xion_attacks",                  0x0cee2000, 0x0d16c600, 0x0d043200, 0, 1},
        {"834",    "hd834",    "834_winner",                        0x0d45bc00, 0x0d6e6200, 0x0d5f7800, 0, 1},
        {"835",    "hd835",    "835_skyscrapper_battle",            0x0d5e0400, 0x0d86aa00, 0x0d782e00, 0, 1},
        {"836",    "hd836_mm", "836_roxas_and_riku",                0x0d6f9400, 0x0d983a00, 0x0d8a7e00, 0, 1},
        {"837",    "hd837_mm", "837_riku_turns_into_ansem",         0x0da1ea00, 0x0dca9000, 0x0dbed000, 0, 1},
        {"838",    "hd838",    "838_clocktower",                    0x0e063600, 0x0e063600, 0x0e063600, 0, 1}, // double cutscene complement
        {"839_de", "hd839",    "839_riku_please_stop_him_de",       0x0e0db400, 0x0e0db400, 0x0e0db400, 0, 1}, // double cutscene complement
        {"839_en", "hd839",    "839_riku_please_stop_him_en",       0x0e0e1200, 0x0e0e1200, 0x0e0e1200, 0, 1}, // double cutscene complement
        {"839_es", "hd839",    "839_riku_please_stop_him_es",       0x0e0e6c00, 0x0e0e6c00, 0x0e0e6c00, 0, 1}, // double cutscene complement
        {"839_fr", "hd839",    "839_riku_please_stop_him_fr",       0x0e0ecc00, 0x0e0ecc00, 0x0e0ecc00, 0, 1}, // double cutscene complement
        {"839_it", "hd839",    "839_riku_please_stop_him_it",       0x0e0f1600, 0x0e0f1600, 0x0e0f1600, 0, 1}, // double cutscene complement
        {"840",    "hd840_mm", "840_after_the_battle",              0x0e0f5e00, 0x0e380400, 0x0e2e4200, 0, 1},
        {"841",    "hd841",    "841_xion_fading_from_clocktower",   0x0e444c00, 0x0e444c00, 0x0e444c00, 0, 1}, // double cutscene complement
        {"842",    "hd842",    "842_a_new_day",                     0x0e4bd400, 0x0e747a00, 0x0e6dfa00, 0, 1},
        {"843",    "hd843_mm", "843_the_usual_spot",                0x0e641200, 0x0e8cb800, 0x0e873800, 0, 1},
        {"845",    "hd845",    "845_the_dark_margin_sora_whisper",  0x0e6fa600, 0x0e984c00, 0x0e938e00, 0, 1},
        {"846",    "hd846_mm", "846_axel_and_saix",                 0x0e75bc00, 0x0e9e6200, 0x0e99ee00, 0, 1},
        {"847",    "hd847_mm", "847_roxas_leaves_the_organization", 0x0e9c2000, 0x0ec4c600, 0x0ec12c00, 0, 1},
        {"848",    "hd848_mm", "848_xions_end",                     0x0eb91800, 0x0ee1be00, 0x0edf4600, 0, 1},
    }};

    Dialogues = std::array<Plugins::CutsceneEntry, 103> {{
        {"000" , "hd000" ,  "000_day_7_when_we_first_met",          0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"002" , "hd002" ,  "002_day_7_the_castle_that_never_was",  0x6f2f696d, 0x00000000, 0x00000000, 0, 8},
        {"003" , "hd003" ,  "003_day_7_all_i_had",                  0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"004" , "hd004" ,  "004_day_8_icing_on_the_cake_part_1",   0x8ed1d22a, 0x00000000, 0x00000000, 0, 8},
        {"006" , "hd006" ,  "006_day_8_icing_on_the_cake_part_2",   0x8e475c2a, 0x00000000, 0x00000000, 0, 8},
        {"007a", "hd007a",  "007a_day_",                            0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"007b", "hd007b",  "007b_day_",                            0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"007c", "hd007c",  "007c_day_",                            0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"007d", "hd007d",  "007d_day_",                            0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"007e", "hd007e",  "007e_day_",                            0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"008" , "hd008" ,  "008_day_14",                           0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"009" , "hd009" ,  "009_day_14",                           0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"010" , "hd010" ,  "010_day_22",                           0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"011" , "hd011" ,  "011_day_23",                           0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"012" , "hd012" ,  "012_day_",                             0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"017" , "hd017" ,  "017_day_24",                           0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"018" , "hd018" ,  "018_day_24",                           0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"019" , "hd019" ,  "019_day_24",                           0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"020" , "hd020" ,  "020_day_25",                           0x8e479c04, 0x00000000, 0x00000000, 0, 8},
        {"021" , "hd021" ,  "021_day_25",                           0x930be219, 0x00000000, 0x00000000, 0, 8},
        {"022" , "hd022" ,  "022_day_25",                           0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"024" , "hd024" ,  "024_day_26",                           0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"025" , "hd025" ,  "025_day_26",                           0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"027" , "hd027" ,  "027_day_27",                           0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"028" , "hd028" ,  "028_day_49_sleep",                     0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"029" , "hd029" ,  "029_day_50_familiar_sound",            0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"030" , "hd030" ,  "030_day_50",                           0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"031" , "hd031" ,  "031_day_50",                           0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"033" , "hd033" ,  "033_day_51",                           0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"034" , "hd034" ,  "034_day_71",                           0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"035" , "hd035" ,  "035_day_71",                           0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"036" , "hd036" ,  "036_day_72",                           0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"039" , "hd039" ,  "039_day_72",                           0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"043a", "hd043a",  "043a_day_74_part_1",                   0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"043b", "hd043b",  "043b_day_74_part_2",                   0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"044" , "hd044" ,  "044_day_74",                           0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"046" , "hd046" ,  "046_day_75",                           0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"048a", "hd048a",  "048a_day_94_hearts_part_1",            0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"048b", "hd048b",  "048b_day_94_hearts_part_2",            0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"050" , "hd050" ,  "050_day_95_nobodies_part_1",           0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"051" , "hd051" ,  "051_day_95_nobodies_part_2",           0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"054" , "hd054" ,  "054_day_96",                           0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"055" , "hd055" ,  "055_day_96",                           0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"056" , "hd056" ,  "056_day_117_secrets_part_1",           0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"059" , "hd059" ,  "059_day_117_secrets_part_2",           0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"063" , "hd063" ,  "063_day_118",                          0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"064" , "hd064" ,  "064_day_118",                          0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"065" , "hd065" ,  "065_day_",                             0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"066a", "hd066a",  "066a_day_",                            0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"066b", "hd066b",  "066b_day_",                            0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"067" , "hd067" ,  "067_day_",                             0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"068" , "hd068" ,  "068_day_150",                          0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"070" , "hd070" ,  "070_day_",                             0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"071" , "hd071" ,  "071_day_",                             0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"074" , "hd074" ,  "074_day_",                             0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"076" , "hd076" ,  "076_day_",                             0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"077" , "hd077" ,  "077_day_",                             0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"080" , "hd080" ,  "080_day_",                             0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"082a", "hd082a",  "082a_day_",                            0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"082b", "hd082b",  "082b_day_",                            0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"084" , "hd084" ,  "084_day_",                             0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"085" , "hd085" ,  "085_day_",                             0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"086a", "hd086a",  "086a_day_",                            0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"086b", "hd086b",  "086b_day_",                            0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"086h", "hd086h",  "086h_day_",                            0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"087" , "hd087" ,  "087_day_",                             0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"089" , "hd089" ,  "089_day_",                             0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"090" , "hd090" ,  "090_day_",                             0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"092" , "hd092" ,  "092_day_",                             0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"094" , "hd094" ,  "094_day_",                             0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"095" , "hd095" ,  "095_day_",                             0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"096" , "hd096" ,  "096_day_",                             0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"098" , "hd098" ,  "098_day_",                             0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"099" , "hd099" ,  "099_day_",                             0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"100a", "hd100a",  "100a_day_",                            0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"106" , "hd106" ,  "106_day_",                             0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"107" , "hd107" ,  "107_day_",                             0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"108" , "hd108" ,  "108_day_",                             0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"109" , "hd109" ,  "109_day_",                             0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"110" , "hd110" ,  "110_day_",                             0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"111" , "hd111" ,  "111_day_",                             0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"112a", "hd112a",  "112a_day_",                            0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"112b", "hd112b",  "112b_day_",                            0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"112c", "hd112c",  "112c_day_",                            0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"113" , "hd113" ,  "113_day_",                             0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"115b", "hd115b",  "115b_day_",                            0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"116" , "hd116" ,  "116_day_",                             0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"117" , "hd117" ,  "117_day_",                             0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"118" , "hd118" ,  "118_day_",                             0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"119" , "hd119" ,  "119_day_",                             0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"123" , "hd123" ,  "123_day_",                             0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"124" , "hd124" ,  "124_day_",                             0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"126" , "hd126" ,  "126_day_",                             0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"127" , "hd127" ,  "127_day_",                             0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"128" , "hd128" ,  "128_day_",                             0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"129" , "hd129" ,  "129_day_",                             0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"130a", "hd130a",  "130a_day_",                            0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"131a", "hd131a",  "131a_day_",                            0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"132" , "hd132" ,  "132_day_",                             0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"132a", "hd132a",  "132a_day_",                            0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"133b", "hd133b",  "133b_day_",                            0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"136" , "hd136" ,  "136_day_",                             0x07000000, 0x00000000, 0x00000000, 0, 8},

        {"830",  "hd830_mm","830_day_354_mickey_and_riku_ansem",    0x8E46F41C, 0x00000000, 0x00000000, 0, 8|0x10000},
    }};
...
int PluginKingdomHeartsDays::detectGameScene()
{
    ...
    bool isDeathScreen = nds->ARM7Read8(getAnyByCart(PAUSE_SCREEN_TYPE_ADDRESS_US, PAUSE_SCREEN_TYPE_ADDRESS_EU, PAUSE_SCREEN_TYPE_ADDRESS_JP, PAUSE_SCREEN_TYPE_ADDRESS_JP_REV1)) ==
        getAnyByCart(PAUSE_SCREEN_WITHOUT_LABEL_WITH_WITHDRAW_VALUE_US, PAUSE_SCREEN_WITHOUT_LABEL_WITH_WITHDRAW_VALUE_EU, PAUSE_SCREEN_WITHOUT_LABEL_WITH_WITHDRAW_VALUE_JP, PAUSE_SCREEN_WITHOUT_LABEL_WITH_WITHDRAW_VALUE_JP_REV1);
    ...
    if (!isUnplayableArea && isDeathScreen)
    {
...
bool PluginKingdomHeartsDays::didInEngineCutsceneEnded()
{
    ...
    if (cutsceneAddressValue != 0) {
        ...
        if (currentCutscene != nullptr && currentCutscene->usAddress != CurrentCutscene()->usAddress) {
            return true;
        }
    }
...
std::filesystem::path PluginKingdomHeartsDays::patchReplacementCutsceneIfNeeded(CutsceneEntry* cutscene, std::filesystem::path folderPath) {
    ...
    if (!std::filesystem::exists(fullPath))
    {
        ...
        if (strcmp(cutscene->MmName, "hd802_mm") == 0) {
            fullPath = folderPath / "DOP.mp4";
        }
        if (strcmp(cutscene->MmName, "hd817_mm") == 0) {
            fullPath = folderPath / "hd817.mp4";
        }
        if (strcmp(cutscene->MmName, "hd830_mm") == 0) {
            fullPath = folderPath / "hd830.mp4";
        }
        if (strcmp(cutscene->MmName, "hd833_mm") == 0) {
            fullPath = folderPath / "hd833.mp4";
        }
        if (strcmp(cutscene->MmName, "hd836_mm") == 0) {
            fullPath = folderPath / "hd836.mp4";
        }
        if (strcmp(cutscene->MmName, "hd843_mm") == 0) {
...
std::string PluginKingdomHeartsDays::replacementCutsceneFilePath(CutsceneEntry* cutscene) {
    ...
    if ((cutscene->dsScreensState & 0x10000) == 0)
    {
...
u32 PluginKingdomHeartsDays::getCurrentMap()
{
    ...
    if (Map == 128) { // cutscene; TODO: KH IDK if that still applies, or even if supporting that is still relevant
        return priorMap;
    }
