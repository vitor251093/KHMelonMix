...
#define STATIC_CUTSCENE_ADDRESS_US 0x0205d97c
#define STATIC_CUTSCENE_ADDRESS_EU 0x0205d97c
#define STATIC_CUTSCENE_ADDRESS_JP 0x0205d99c
...
PluginKingdomHeartsReCoded::PluginKingdomHeartsReCoded(u32 gameCode)
{
    ...
    Cutscenes = std::array<Plugins::CutsceneEntry, 15> {{
        {"OP",     "hd501",         "501_opening_part_1",         0x04bb3a00, 0x04c1be00, 0x04b04200, 0, 1},
        {"Secret", "hd593",         "593_",                       0x05e9b400, 0x05f03800, 0x05db0200, 0, 1},
        {"w1_ED",  "hd510_PLUS_mm", "510_unaccountable_accounts", 0x06784800, 0x067ecc00, 0x06699e00, 0, 1},
        {"w1_OP",  "hd502",         "502_opening_part_2",         0x06e43800, 0x06eabc00, 0x06d58e00, 0, 4|1},
        {"w2_ED",  "hd516_PLUS_mm", "516_",                       0x07c4ee00, 0x07cb7200, 0x07b64400, 0, 1},
        {"w2_OP",  "hd512_PLUS_mm", "512_",                       0x08548600, 0x085b0a00, 0x0845f800, 0, 1},
        {"w3_ED",  "hd524",         "524_",                       0x08706200, 0x0876e600, 0x0861D400, 0, 1},
        {"w4_ED",  "hd531",         "531_",                       0x09503000, 0x0956b400, 0x0941a200, 0, 1},
        {"w5_ED",  "hd539_PLUS_mm", "539_",                       0x09990800, 0x099f8c00, 0x098a7a00, 0, 1},
        {"w6_ED",  "hd549",         "549_",                       0x0a3c9400, 0x0a431800, 0x0a2e0600, 0, 1},
        {"w7_ED",  "hd572",         "572_",                       0x0ac3aa00, 0x0aca2e00, 0x0ab51c00, 0, 1},
        {"w8_ED1", "hd590_PLUS_mm", "590_",                       0x0b150400, 0x0b1b8800, 0x0b067600, 0, 1},
        {"w8_ED2", "hd592",         "592_",                       0x0bcd3400, 0x0bd3b800, 0x0bbea600, 0, 1},
        {"w8_ED3", "hd576_PLUS_mm", "576_",                       0x0c216800, 0x0c27ec00, 0x0c12cc00, 0, 1},
        {"w8_OP",  "hd573_PLUS_mm", "573_",                       0x0c426000, 0x0c48e400, 0x0c33c400, 0, 1},
    }};

    Dialogues = std::array<Plugins::CutsceneEntry, 74> {{
        {"503" ,   "hd503_PLUS",    "503_dive_to_the_heart_part_1", 0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"505" ,   "hd505",         "505_dive_to_the_heart_part_2", 0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"506" ,   "hd506",         "506_destiny_islands_part_1",   0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"507" ,   "hd507",         "507_destiny_islands_part_2",   0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"508" ,   "hd508",         "508_destiny_islands_part_3",   0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"509" ,   "hd509",         "509_destiny_islands_part_4",   0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"510" ,   "hd510_PLUS",    "510_destiny_islands_part_5",   0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"512" ,   "hd512_PLUS",    "512_traverse_town_part_1",     0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"514" ,   "hd514",         "514_traverse_town_part_2",     0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"515" ,   "hd515",         "515_traverse_town_part_3",     0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"516" ,   "hd516_PLUS",    "516_traverse_town_part_4",     0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"518" ,   "hd518",         "518_wonderland_part_1",        0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"519" ,   "hd519",         "519_wonderland_part_2",        0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"520" ,   "hd520",         "520_wonderland_part_3",        0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"521" ,   "hd521",         "521_wonderland_part_4",        0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"522" ,   "hd522_PLUS",    "522_wonderland_part_5",        0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"524" ,   "hd524",         "524_wonderland_part_6",        0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"525" ,   "hd525",         "525_olympus_part_1",           0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"528" ,   "hd528",         "528_olympus_part_2",           0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"530" ,   "hd530",         "530_olympus_part_3",           0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"531" ,   "hd531",         "531_olympus_part_4",           0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"532" ,   "hd532",         "532_agrabah_part_1",           0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"535" ,   "hd535",         "535_agrabah_part_2",           0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"536" ,   "hd536",         "536_agrabah_part_3",           0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"538" ,   "hd538",         "538_agrabah_part_4",           0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"539" ,   "hd539_PLUS",    "539_agrabah_part_5",           0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"542" ,   "hd542",         "542_hollow_bastion_part_1",    0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"543" ,   "hd543",         "543_hollow_bastion_part_2",    0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"544" ,   "hd544",         "544_hollow_bastion_part_3",    0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"545" ,   "hd545",         "545_hollow_bastion_part_4",    0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"546" ,   "hd546",         "546_hollow_bastion_part_5",    0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"547" ,   "hd547",         "547_hollow_bastion_part_6",    0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"548" ,   "hd548",         "548_hollow_bastion_part_7",    0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"549" ,   "hd549",         "549_hollow_bastion_part_8",    0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"550" ,   "hd550",         "550_rikus_datascape_part_1",   0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"551" ,   "hd551",         "551_rikus_datascape_part_2",   0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"552" ,   "hd552",         "552_rikus_datascape_part_3",   0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"553" ,   "hd553",         "553_rikus_datascape_part_4",   0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"554" ,   "hd554",         "554_rikus_datascape_part_5",   0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"555" ,   "hd555",         "555_rikus_datascape_part_6",   0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"556" ,   "hd556",         "556_rikus_datascape_part_7",   0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"557" ,   "hd557",         "557_rikus_datascape_part_8",   0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"558" ,   "hd558",         "558_rikus_datascape_part_9",   0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"559" ,   "hd559",         "559_rikus_datascape_part_10",  0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"560" ,   "hd560",         "560_rikus_datascape_part_11",  0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"561" ,   "hd561",         "561_rikus_datascape_part_12",  0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"562" ,   "hd562_PLUS",    "562_rikus_datascape_part_13",  0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"570" ,   "hd570",         "570_rikus_datascape_part_14",  0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"571" ,   "hd571",         "571_rikus_datascape_part_15",  0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"572" ,   "hd572",         "572_rikus_datascape_part_16",  0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"573" ,   "hd573_PLUS",    "573_castle_oblivion_part_1",   0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"575" ,   "hd575",         "575_castle_oblivion_part_2",   0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"576" ,   "hd576_PLUS",    "576_castle_oblivion_part_3",   0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"579" ,   "hd579",         "579_castle_oblivion_part_4",   0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"580" ,   "hd580",         "580_castle_oblivion_part_5",   0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"581" ,   "hd581",         "581_castle_oblivion_part_6",   0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"582" ,   "hd582",         "582_castle_oblivion_part_7",   0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"583" ,   "hd583",         "583_castle_oblivion_part_8",   0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"584" ,   "hd584",         "584_castle_oblivion_part_9",   0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"585" ,   "hd585",         "585_castle_oblivion_part_10",  0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"586" ,   "hd586",         "586_castle_oblivion_part_11",  0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"587" ,   "hd587",         "587_castle_oblivion_part_12",  0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"588" ,   "hd588",         "588_castle_oblivion_part_13",  0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"589" ,   "hd589",         "589_castle_oblivion_part_14",  0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"590" ,   "hd590_PLUS",    "590_castle_oblivion_part_15",  0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"592" ,   "hd592",         "592_ending_part_1",            0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"593" ,   "hd593",         "593_ending_part_2",            0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"594" ,   "hd594",         "594_ending_part_3",            0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"595" ,   "hd595",         "595_ending_part_4",            0x07000000, 0x00000000, 0x00000000, 0, 8},
        {"596" ,   "hd596",         "596_credits",                  0x07000000, 0x00000000, 0x00000000, 0, 8},
    }};
...
{
    return getU32ByCart(STATIC_CUTSCENE_ADDRESS_US, STATIC_CUTSCENE_ADDRESS_EU, STATIC_CUTSCENE_ADDRESS_JP);
}
