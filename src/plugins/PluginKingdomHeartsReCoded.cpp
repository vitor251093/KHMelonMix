...
std::vector<ShapeData2D> PluginKingdomHeartsReCoded::renderer_2DShapes() {
    ...
    switch (GameScene) {
        ...
        case gameScene_InGameMenu: {
            ...
            if (mainMenuView == 1) // main menu root
            {
                float scale = 192.0/(192 - 31 + 48);
                float statsScale = 0.8;
                ...
                // rest of main menu label header
                shapes.push_back(ShapeBuilder2D::square()
                        .fromPosition(100, 0)
                        .withSize(20, 16)
                        .placeAtCorner(corner_TopRight)
                ...
                shapes.push_back(ShapeBuilder2D::square()
                        ...
                        .withSize(74, 15)
                        .placeAtCorner(corner_Center)
                        .withMargin(123.0 + 37.0, 10.0, 0.0, 0.0)
                        .sourceScale(scale*statsScale, scale*statsScale)
                        .hudScale(hudScale)
                        .preserveDsScale()
                        .build(aspectRatio));
                ...
                shapes.push_back(ShapeBuilder2D::square()
                        ...
                        .withSize(74, 15)
                        .placeAtCorner(corner_Center)
                        .withMargin(123.0 + 37.0, 10.0 + 22.0*statsScale, 0.0, 0.0)
                        .sourceScale(scale*statsScale, scale*statsScale)
                        .hudScale(hudScale)
                        .preserveDsScale()
                        .build(aspectRatio));
                ...
                shapes.push_back(ShapeBuilder2D::square()
                        ...
                        .withSize(65, 15)
                        .placeAtCorner(corner_Center)
                        .withMargin(123.0 + 32.5, 10.0 + 44.0*statsScale, 0.0, 0.0)
                        .sourceScale(scale*statsScale, scale*statsScale)
                        .hudScale(hudScale)
                        .preserveDsScale()
                        .build(aspectRatio));
                ...
                shapes.push_back(ShapeBuilder2D::square()
                        .fromBottomScreen()
                        .fromPosition(184, 105)
                        .withSize(53, 15)
                        .placeAtCorner(corner_Center)
                        .withMargin(123.0 + 91.5, 10.0 + 44.0*statsScale, 0.0, 0.0)
                        .sourceScale(scale*statsScale, scale*statsScale)
                        .hudScale(hudScale)
                        .preserveDsScale()
                        .build(aspectRatio));
                ...
                shapes.push_back(ShapeBuilder2D::square()
                        ...
                        .withSize(65, 15)
                        .placeAtCorner(corner_Center)
                        .withMargin(123.0 + 32.5, 10.0 + 66.0*statsScale, 0.0, 0.0)
                        .sourceScale(scale*statsScale, scale*statsScale)
                        .hudScale(hudScale)
                        .preserveDsScale()
                        .build(aspectRatio));
                ...
                shapes.push_back(ShapeBuilder2D::square()
                        .fromBottomScreen()
                        .fromPosition(184, 121)
                        .withSize(53, 15)
                        .placeAtCorner(corner_Center)
                        .withMargin(123.0 + 91.5, 10.0 + 66.0*statsScale, 0.0, 0.0)
                        .sourceScale(scale*statsScale, scale*statsScale)
                        .hudScale(hudScale)
                        .preserveDsScale()
                        .build(aspectRatio));
